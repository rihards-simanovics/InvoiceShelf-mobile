...
/**
 * The minimum height for the MessageComponent, mainly used in vertical transitions.
 */
const OFFSET_HEIGHT = Platform.OS !== 'ios' ? 60 : 48;

/**
 * Prop type definition for the message object.
 * @typedef {Object} MessagePropType
 * @property {string} message - The main text of the flash message (required).
 * @property {string} [description] - Additional text displayed below the main message (optional).
 * @property {string} [type] - The type of message, which determines its color (optional).
 * @property {string} [backgroundColor] - Custom background color for the message (optional).
 * @property {string} [color] - Custom text color for the message (optional).
 */
 ...
 * @param {string|Object} icon - The icon value to parse.
 * @returns {Object|null} - An object containing icon details or null if no icon is provided.
 */
...
/**
 * Converts string positions like "top", "bottom", and "center" into style classes.
 * @param {Object} style - The base style object.
 * @param {string} position - The position string.
 * @returns {Array} - An array of styles including the position styles.
 */
...
/**
 * Global function to display messages anywhere in your app.
 * Pass a `message` object as the first argument to show flash messages.
 *
 * @param {...Object} args - The message object to display.
 * @returns {void}
 * @example
 * showMessage({
 ...
 *
 * @param {...*} args - Arguments to pass to the hide function.
 * @returns {void}
 * @example
 * hideMessage();
 */
 ...
 * You can create custom transition configurations with interpolation,
 * just ensure to return a style object with transform options.
 *
 * @param {Animated.Value} animValue - The animated value for transitions.
 * @param {string} [position='top'] - The position of the flash message.
 * @returns {Object} - The style object for the transition.
 */
 ...
 * This component is wrapped in `FlashMessageWrapper` to handle orientation changes
 * and extra inset padding on special devices. For most uses, this component does not
 * need to be changed for custom versions as it is highly customizable.
 *
 * @param {Object} props - The component props.
 * @param {Object} ref - The forwarded ref.
 * @returns {JSX.Element} - The rendered flash message component.
 */
 ...
 * You can instantiate and use this component once in your main app screen.
 * For global use, add <FlashMessage /> as the last component in your root main screen.
 *
 * @example
 * <View style={{ flex: 1 }}>
 *   <YourMainApp />
...
export class FlashMessage extends Component {
  static defaultProps = {
    /**
     * Determines if the instance can be registered as the default/global instance.
     */
    ...
    autoHide: true,
    /**
     * Duration in milliseconds for which the flash message will be shown if `autoHide` is true.
     */
    duration: 1850,
    /**
    ...
    statusBarHeight: null,
    /**
     * The `floating` prop unsticks the message from the edges and applies some border radius to the component.
     */
    floating: false,
    /**
     * The `position` prop sets the position of the flash message.
     * Expected options: "top" (default), "bottom", "center", or a custom object with { top, left, right, bottom } positions.
     */
    position: 'top',
    /**
     * The `renderCustomContent` prop renders JSX below the title of the flash message.
    ...
    icon: 'none',
    /**
     * The `renderFlashMessageIcon` prop sets a custom render function for the message icons.
     */
    renderFlashMessageIcon,
    /**
     * The `transitionConfig` prop sets the transition configuration function used in show/hide animations.
     */
    transitionConfig: FlashMessageTransition,
    /**
     * The `MessageComponent` prop sets the default flash message render component used to show all the messages.
     */
   ...
   * @param {Object} message - The message object.
   * @returns {boolean} - True if the message should be animated, false otherwise.
   */
  isAnimated(message) {
   ...
   * @param {Object} event - The long press event.
   * @returns {void}
   */
   ...
   * @param {boolean} [visible=true] - Whether the message should be visible.
   * @param {boolean} [animated=true] - Whether the toggle should be animated.
   * @param {function} [done] - Callback function to execute after the toggle is complete.
   * @returns {void}
   */
   ...
   *
   * @param {Object|string} message - The message object or string to display.
   * @param {string|null} [description=null] - The description of the message.
   * @param {string} [type='default'] - The type of message (e.g., success, error).
   * @returns {void}
   * @example
  ...
  _hideTimeout; // Timeout for hiding the message
  _id; // Unique identifier for the message instance
}

/**
 * Styles for the FlashMessage component.
 * This includes positioning, layout, and appearance for various elements of the flash message.
 */
